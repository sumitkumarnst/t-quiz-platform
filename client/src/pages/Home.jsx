...
export default function Home() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen relative overflow-hidden">
            ...
            <div className="absolute top-20 right-20 w-48 h-48 bg-yellow-400/20 rounded-full blur-[100px] animate-pulse-slow"></div>
            <div className="absolute bottom-10 left-10 w-40 h-40 bg-yellow-300/15 rounded-full blur-[90px] animate-pulse-slow " style={{ animationDelay: '1s' }}></div>
            <div className="absolute top-1/3 right-1/3 w-32 h-32 bg-yellow-200/15 rounded-full blur-[60px] animate-pulse-slow " style={{ animationDelay: '2s' }}></div>
